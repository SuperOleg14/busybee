<?php if( have_rows('single_services') ): ?>
    <?php while( have_rows('single_services') ): the_row(); ?>
        <div class="related-service-posts related-portfolio-posts">
            <div class="container">
                <?php if( have_rows('single_services_portfolio') ): ?>
                    <?php while( have_rows('single_services_portfolio') ): the_row(); ?>
                        <div class="block-title block-text-align width-content">
                            <?php echo get_sub_field( 'single_services_portfolio_title' ); ?>
                        </div>
                        <div class="related-portfolio-posts__content d-flex --just-space --align-stretch">
                            <?php if( $portfolio_posts_for_service = get_sub_field('related_portfolio_for_service') ): ?>
                        ...
                        <?php $relatedPortfolioPoststLink = get_sub_field('single_services_portfolio_link'); ?>
